...
root.geometry('990x750')
root.configure(background='green')
root.title("Checkers")

logo = PhotoImage(file="board_img/whitebox.gif")  # Loading all the image files that are required in the game.
logo2 = PhotoImage(file="board_img/red side.gif")  # Loading all the image files that are required in the game.
logo3 = PhotoImage(file="board_img/red.gif")  # Loading all the image files that are required in the game.
logo4 = PhotoImage(file="board_img/blue side.gif")
logo5 = PhotoImage(file="board_img/green side.gif")
logo6 = PhotoImage(file="board_img/yellow side.gif")
logo7 = PhotoImage(file="board_img/center.gif")
logoxx = PhotoImage(file="board_img/test.gif")
logog = PhotoImage(file="board_img/greenbox.gif")
logogs = PhotoImage(file="board_img/greenstop.gif")
logoy = PhotoImage(file="board_img/yellowbox.gif")
logoys = PhotoImage(file="board_img/yellowstop.gif")
logob = PhotoImage(file="board_img/bluebox.gif")
logobs = PhotoImage(file="board_img/bluestop.gif")
logor = PhotoImage(file="board_img/redbox.gif")
logors = PhotoImage(file="board_img/redstop.gif")
logoh = PhotoImage(file="board_img/head.gif")
logot = PhotoImage(file="board_img/tail.gif")
logoh1 = PhotoImage(file="board_img/head1.gif")
logot1 = PhotoImage(file="board_img/tail1.gif")
logoh2 = PhotoImage(file="board_img/head2.gif")
logot2 = PhotoImage(file="board_img/tail2.gif")
logoh3 = PhotoImage(file="board_img/head3.gif")
logot3 = PhotoImage(file="board_img/tail3.gif")
logoab = PhotoImage(file="board_img/blue.gif")
logoay = PhotoImage(file="board_img/yellow.gif")
logoag = PhotoImage(file="board_img/green.gif")
                    ...
                    for i in range(len(red)):
                        ...
                        if ((((cx > red[i].x0 + 13) and (cx < red[i].x + 13)) and (  # if gamepiece is outside home
                            ...
                            kill(redbox, blue, yellow, green, bluehome, yellowhome,
                                 greenhome)  # checks if a kill can be made.
